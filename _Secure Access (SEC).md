...
conf t
 ...
 router ospf 1
  ...
  network 11.0.0.1 0.0.0.0 area 11
 int gi 0/0/0
...
~~~
!@NetOps
ip route add 10.0.0.0/8 via 10.11.1.4
ip route add 200.0.0.0/24 via 10.11.1.4
~~~
...
- Subject Alt Names:                         rivan.com  www.rivan.com  api.rivan.com  10.11.1.6
...
Review: Create a DNS A record for www.ccna11.com
...
1. Make the www.rivan11.com accessible via port 8080
